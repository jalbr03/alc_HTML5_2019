...
function game(){
    ...
    function prison(){
        var prison = prompt("You wake up...Your head is puonding and vision blurred. After pacing around walking off the headache your vision clears. It appears you are in prison and you cannot remember why. /n -look around /n - go back to sleep /n - taunt the guard").toLowerCase();
        
        if(prison == "look around" || prison == "look"){
            var prisonLook = prompt("The prison is small, dirty and damp. A rat scurries into a hole in the corner, Bugs squirm and scamper underfoot. There is a barred window to the back. an occupied bed a stranger asleep anoring to the right. The cell bars and locked door to the front. An empty bed whitch you had sleeped in the night before to the right. In the center of the dirt floor is lumpy moldy rug. /n -wake stranger /n move rug /n -eat bugs");
        }
